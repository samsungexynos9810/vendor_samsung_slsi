...
outputs="vendor/samsung_slsi/hardware/exynosdisplayfeature/1.0/default"
...
hidl-gen -Landroidbp -o $outputs $options vendor.samsung_slsi.hardware.exynosdisplayfeature@1.0;
hidl-gen -Lc++-headers -o $outputs $options vendor.samsung_slsi.hardware.exynosdisplayfeature@1.0;
hidl-gen -Lc++-impl $options -o $outputs vendor.samsung_slsi.hardware.exynosdisplayfeature@1.0;
hidl-gen -Lhash $options vendor.samsung_slsi.hardware.exynosdisplayfeature@1.0;
