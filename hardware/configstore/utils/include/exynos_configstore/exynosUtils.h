...
#ifndef VENDOR_SAMSUNG_SLSI_HARDWARE_CONFIGSTORE_UTILS_H
#define VENDOR_SAMSUNG_SLSI_HARDWARE_CONFIGSTORE_UTILS_H

#include <vendor/samsung_slsi/hardware/configstore/1.0/types.h>
...
using ::vendor::samsung_slsi::hardware::configstore::V1_0::OptionalBool;
using ::vendor::samsung_slsi::hardware::configstore::V1_0::OptionalInt32;
using ::vendor::samsung_slsi::hardware::configstore::V1_0::OptionalUInt32;
using ::vendor::samsung_slsi::hardware::configstore::V1_0::OptionalInt64;
using ::vendor::samsung_slsi::hardware::configstore::V1_0::OptionalUInt64;
using ::vendor::samsung_slsi::hardware::configstore::V1_0::OptionalString;

// a function to retrieve and cache the service handle
// for a particular interface
template <typename I>
android::sp<I> getService() {
    // static initializer used for synchronizations
    static android::sp<I> configs = I::getService();
    return configs;
}
...
decltype(V::value) get(const decltype(V::value) &defValue) {
    ...
    auto getHelper = []()->V {
        V ret;
        android::sp<I> configs = getService<I>();
        ...
        if (!configs.get()) {
            ...
            if (!status.isOk()) {
                ...
                details::logAlwaysError(oss.str());
                ret.specified = false;
            }
        }
