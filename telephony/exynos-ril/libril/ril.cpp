...
/*******************************************************************/
extern CommandInfo *getCommandInfo(int request);
extern UnsolResponseInfo *getUnsolRespInfo(int unsolResponse);
/*******************************************************************/
...
addRequestToList(int serial, int slotId, int request) {
    ...
    pRI->token = serial;
    pRI->pCI = android::getCommandInfo(request);
...
#endif
{
    ...
    UnsolResponseInfo *unsolResponseHook = android::getUnsolRespInfo(unsolResponse);
...
*/
    switch(request) {
        ...
        case RIL_UNSOL_EMERGENCY_NUMBER_LIST: return "RIL_UNSOL_EMERGENCY_NUMBER_LIST";
        ...
        case RIL_REQUEST_READ_PB_ENTRY: return "RIL_REQUEST_READ_PB_ENTRY";
        case RIL_REQUEST_UPDATE_PB_ENTRY: return "RIL_REQUEST_UPDATE_PB_ENTRY";
        case RIL_REQUEST_GET_PB_STORAGE_INFO: return "RIL_REQUEST_GET_PB_STORAGE_INFO";
        case RIL_REQUEST_GET_PB_ENTRY_INFO: return "RIL_REQUEST_GET_PB_ENTRY_INFO";
        case RIL_REQUEST_GET_3G_PB_CAPA: return "RIL_REQUEST_GET_3G_PB_CAPA";
        ...
        case RIL_UNSOL_PB_READY: return "UNSOL_PB_READY";
