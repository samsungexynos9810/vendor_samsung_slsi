...
public class VzwTestModeActivity extends Activity {
    ...
    public void onNextFragment(String plmn, int subId) {
        getFragmentManager().beginTransaction().replace(R.id.content, VzwTestModePreferenceFragment.newInstance(subId)).commit();
    }
