...
import com.android.slsi.blacklist.SmsLogBatchAdapter.ViewHolder;
...
public class SmsLogBatchActivity extends Activity {
    ...
    private SmsLogBatchAdapter mSmsLogBatchAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSmsLogBatchAdapter = new SmsLogBatchAdapter(this,getCursor());
        mListview.setAdapter(mSmsLogBatchAdapter);
        ...
        mSelectAllBtn.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Set<Integer> set = SmsLogBatchAdapter.isSelected.keySet();
                for (Integer itemId : set) {
                    SmsLogBatchAdapter.isSelected.put(itemId, true);
                }
                mSmsLogBatchAdapter.notifyDataSetChanged();
                isAllSelected = true;
            }
        });
        mNotSelectAllBtn.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Set<Integer> set = SmsLogBatchAdapter.isSelected.keySet();
                for (Integer itemId : set) {
                    SmsLogBatchAdapter.isSelected.put(itemId, false);
                }
                mSmsLogBatchAdapter.notifyDataSetChanged();
                isAllSelected = false;
            }
        ...
        mDeleteBtn.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if (isAllSelected) {
                    resolver.delete(DBConfig.SmsInfo.CONTENT_URI, null, null);
                    Set<Integer> set = SmsLogBatchAdapter.isSelected.keySet();
                    for (Integer itemId : set) {
                        SmsLogBatchAdapter.isSelected.put(itemId, false);
                    }
                    ...
                    Set<Integer> set = SmsLogBatchAdapter.isSelected.keySet();
                    for (Integer itemId : set) {
                        if (SmsLogBatchAdapter.isSelected.get(itemId)) {
        ...
        mListview.setOnItemClickListener(new OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                SmsLogBatchAdapter.isSelected.put((int)id,
                        vHollder.checkbox.isChecked());
                int mSelectCount =0;
                for (Boolean value : SmsLogBatchAdapter.isSelected.values()) {
                    if (value) {
                        ++mSelectCount;
                    }
                }
