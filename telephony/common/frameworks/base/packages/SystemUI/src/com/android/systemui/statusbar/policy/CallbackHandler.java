...
public class CallbackHandler extends Handler implements EmergencyListener, SignalCallback {
    ...
    @Override
    public void setMobileDataIndicators(final IconState statusIcon, final IconState qsIcon,
            final int voiceStatusType, final int statusType, final int qsType, final boolean activityIn,
            final boolean activityOut, final String typeContentDescription,
            final String description, final boolean isWide, final int subId, final boolean isRoaming, final boolean imsReg) {
        post(new Runnable() {
            @Override
            public void run() {
                for (SignalCallback signalCluster : mSignalCallbacks) {
                    signalCluster.setMobileDataIndicators(statusIcon, qsIcon, voiceStatusType, statusType, qsType,
                            activityIn, activityOut, typeContentDescription, description, isWide,
                            subId, isRoaming, imsReg);
                }
            }
        });
    }
