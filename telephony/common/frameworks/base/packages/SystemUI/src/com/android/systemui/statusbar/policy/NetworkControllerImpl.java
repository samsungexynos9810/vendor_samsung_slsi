...
//    static final boolean CHATTY =  Log.isLoggable(TAG + "Chat", Log.DEBUG);
    ...
    protected void updateNoSims() {
        ...
        Log.d(TAG, "updateNoSims hasNoSubs("+hasNoSubs+"), simDetected("+simDetected+"), mHasMobileDataFeature("+mHasMobileDataFeature+"), size("+mMobileSignalControllers.size()+")");
            ...
            if (mobile != null) {
                ...
                if (datatype != null) {
                    controller.getState().iconGroup =
                            ...
                            datatype.equals("3g") ?
                            ((BUILD_CARRIER.equals("att") || BUILD_CARRIER.equals("tmo")) ? TelephonyIcons.THREE_G_TWO : TelephonyIcons.THREE_G) :
                            datatype.equals("4g") ?
                            ((BUILD_CARRIER.equals("att") || BUILD_CARRIER.equals("tmo"))? TelephonyIcons.FOUR_G_LTE : TelephonyIcons.FOUR_G) :
                            ...
                            datatype.equals("lte") ?
                            ((BUILD_CARRIER.equals("att") || BUILD_CARRIER.equals("tmo"))? TelephonyIcons.FOUR_G_LTE : TelephonyIcons.LTE) :
