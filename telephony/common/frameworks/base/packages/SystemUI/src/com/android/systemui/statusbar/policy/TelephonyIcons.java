...
class TelephonyIcons {
    ...
    static final int ICON_3G_PLUS = R.drawable.stat_sys_data_fully_connected_3g;
    ...
    static final int ICON_X = R.drawable.stat_sys_data_fully_connected_x;
    ...
    static final MobileIconGroup THREE_G_TWO = new MobileIconGroup(
            "3G",
            null,
            null,
            AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH,
    ...
    static final MobileIconGroup UNKNOWNDATA = new MobileIconGroup(
            "Unknown",
            null,
            null,
            AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH,
