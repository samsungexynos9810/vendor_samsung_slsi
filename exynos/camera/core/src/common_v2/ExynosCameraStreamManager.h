...
public:
    ...
    virtual status_t          setPhysCameraID(int);
    virtual int               getPhysCameraID();
    virtual status_t          getSize(uint32_t *width, uint32_t *height);
    virtual bool              isPhysCameraStream();
