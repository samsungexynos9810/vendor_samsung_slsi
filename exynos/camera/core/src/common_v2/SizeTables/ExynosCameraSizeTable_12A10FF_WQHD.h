...
#ifndef EXYNOS_CAMERA_LUT_12A10FF_H
#define EXYNOS_CAMERA_LUT_12A10FF_H
...
static int PREVIEW_SIZE_LUT_12A10FF[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1440p */
...
static int PICTURE_SIZE_LUT_12A10FF[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int VIDEO_SIZE_LUT_12A10FF[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int VIDEO_SIZE_LUT_60FPS_HIGH_SPEED_12A10FF[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_120FPS_HIGH_SPEED_12A10FF[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_240FPS_HIGH_SPEED_12A10FF[][SIZE_OF_LUT] =
{
};

static int VTCALL_SIZE_LUT_12A10FF[][SIZE_OF_LUT] =
{
    /* Binning   = 2
       BNS ratio = 1.0
       BDS       = ON */
...
static int FAST_AE_STABLE_SIZE_LUT_12A10FF[][SIZE_OF_LUT] =
{
    /* Binning   = ON
...
static int PREVIEW_FULL_SIZE_LUT_12A10FF[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int PICTURE_FULL_SIZE_LUT_12A10FF[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int OV12A10FF_YUV_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int OV12A10FF_YUV_REPROCESSING_INPUT_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
    { 4096, 3072, 33331760, SIZE_RATIO_4_3},
};
...
/* yuv reprocessing input stream size list */
static int OV12A10FF_RAW_OUTPUT_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
    { 4096, 3072, 33331760, SIZE_RATIO_4_3},
};
...
static int OV12A10FF_JPEG_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
    { 4096, 3072, 33331760, SIZE_RATIO_4_3},
    { 4096, 2304, 33331760, SIZE_RATIO_16_9},
...
static int OV12A10FF_THUMBNAIL_LIST[][SIZE_OF_RESOLUTION] =
{
...
/* For HAL3 */
static int OV12A10FF_HIGH_SPEED_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
    { 1280,   720, 120, SIZE_RATIO_16_9},
};

static int OV12A10FF_FPS_RANGE_LIST[][2] =
{
    {   7000,  15000},
    {  15000,  15000},
    {   7000,  20000},
...
static int OV12A10FF_HIDDEN_FPS_RANGE_LIST[][2] =
{
    {  60000,  60000},
};

/* For HAL3 */
static int OV12A10FF_HIGH_SPEED_VIDEO_FPS_RANGE_LIST[][2] =
{
    { 30000, 120000},
    { 120000, 120000},
};
...
static int OV12A10FF_AVAILABLE_VIDEO_LIST[][7] =
{
...
static int OV12A10FF_AVAILABLE_HIGH_SPEED_VIDEO_LIST[][5] =
{
    { 1280, 720, 120000, 120000, 0},
};

/* effect fps range */
static int OV12A10FF_EFFECT_FPS_RANGE_LIST[][2] =
{
    {  10000,  24000},
    {  24000,  24000},
};

static camera_metadata_rational COLOR_MATRIX1_OV12A10FF_3X3[] =
{
...
static camera_metadata_rational COLOR_MATRIX2_OV12A10FF_3X3[] =
{
...
static camera_metadata_rational FORWARD_MATRIX1_OV12A10FF_3X3[] =
{
...
static camera_metadata_rational FORWARD_MATRIX2_OV12A10FF_3X3[] =
{
