...
static int PREVIEW_FULL_SIZE_LUT_3L2[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int PICTURE_FULL_SIZE_LUT_3L2[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = OFF */
...
static int S5K3L2_JPEG_LIST[][SIZE_OF_RESOLUTION] =
{
    { 4128, 3096, 33331760, SIZE_RATIO_4_3},
    { 4128, 2322, 33331760, SIZE_RATIO_16_9},
    { 3264, 2448, 33331760, SIZE_RATIO_4_3},
    { 3264, 1836, 33331760, SIZE_RATIO_16_9},
    { 3088, 3088, 33331760, SIZE_RATIO_1_1},
