...
static int SAK2T7SX_YUV_REPROCESSING_INPUT_LIST[][SIZE_OF_RESOLUTION] =
{
    { 4608, 3456, 33331760, SIZE_RATIO_4_3 },
};

/* Raw output stream size list */
static int SAK2T7SX_RAW_OUTPUT_LIST[][SIZE_OF_RESOLUTION] =
{
    { 4608, 3456, 33331760, SIZE_RATIO_4_3 },
};
...
static int SAK2T7SX_AF_FOV_SIZE_LIST[][6] =
{
    /*
    ...
    { 0, 1023,  80000000, 1000000, 4544254, 1056803}, /* [MinLensPosition, MaxLensPosition, Dist_macro_end, fudge_factor, lens_shift_max, mag_factor_max] */
};
