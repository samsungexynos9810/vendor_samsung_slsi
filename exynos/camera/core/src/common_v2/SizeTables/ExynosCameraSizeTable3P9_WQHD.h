...
#ifndef EXYNOS_CAMERA_LUT_3P9_H
#define EXYNOS_CAMERA_LUT_3P9_H
...
static int PREVIEW_SIZE_LUT_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1440p */
...
static int PREVIEW_SIZE_LUT_3P9_BNS[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.5
       BDS       = 1440p */
...
static int PICTURE_SIZE_LUT_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = OFF */
...
static int VIDEO_SIZE_LUT_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1440p */
...
static int VIDEO_SIZE_LUT_120FPS_HIGH_SPEED_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_240FPS_HIGH_SPEED_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_SSM_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VTCALL_SIZE_LUT_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = 2
       BNS ratio = 1.0
       BDS       = ON */
...
static int FAST_AE_STABLE_SIZE_LUT_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = ON
...
static int PREVIEW_FULL_SIZE_LUT_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int PICTURE_FULL_SIZE_LUT_3P9[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int S5K3P9_YUV_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int S5K3P9_JPEG_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
...
static int S5K3P9_HIDDEN_PREVIEW_SIZE_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int S5K3P9_HIDDEN_PICTURE_SIZE_LIST[][SIZE_OF_RESOLUTION] =
{
    { 4608, 2240, 50000000, SIZE_RATIO_18P5_9},
};

/* For HAL3 */
static int S5K3P9_HIGH_SPEED_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
    { 1920,  1080, 0, SIZE_RATIO_16_9},
    { 1280,   720, 0, SIZE_RATIO_16_9},
};

static int S5K3P9_FPS_RANGE_LIST[][2] =
{
    {  15000,  15000},
    {  10000,  24000},
    {  15000,  24000},
...
/* For HAL3 */
static int S5K3P9_HIGH_SPEED_VIDEO_FPS_RANGE_LIST[][2] =
{
    {  30000, 120000},
    {  60000, 120000},
    { 120000, 120000},
...
static int S5K3P9_AVAILABLE_VIDEO_LIST[][7] =
{
...
static int S5K3P9_AVAILABLE_HIGH_SPEED_VIDEO_LIST[][5] =
{
...
static camera_metadata_rational COLOR_MATRIX1_3P9_3X3[] =
{
...
static camera_metadata_rational COLOR_MATRIX2_3P9_3X3[] =
{
...
static camera_metadata_rational FORWARD_MATRIX1_3P9_3X3[] =
{
...
static camera_metadata_rational FORWARD_MATRIX2_3P9_3X3[] =
{
