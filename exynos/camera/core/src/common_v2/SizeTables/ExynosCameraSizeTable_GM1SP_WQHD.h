...
#ifndef EXYNOS_CAMERA_LUT_GM1SP_H
#define EXYNOS_CAMERA_LUT_GM1SP_H
...
static int PREVIEW_SIZE_LUT_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1440p */
...
static int PICTURE_SIZE_LUT_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = OFF */
...
static int VIDEO_SIZE_LUT_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int VIDEO_SIZE_LUT_60FPS_HIGH_SPEED_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_120FPS_HIGH_SPEED_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_240FPS_HIGH_SPEED_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VTCALL_SIZE_LUT_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = 2
       BNS ratio = 1.0
       BDS       = ON */
...
static int FAST_AE_STABLE_SIZE_LUT_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = ON
...
static int PREVIEW_FULL_SIZE_LUT_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int PICTURE_FULL_SIZE_LUT_GM1SP[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int SAKGM1SP_YUV_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
#ifndef SUPPORT_8M_LINE_BUFFER_SIZE
    { 4000, 3000, 33331760, SIZE_RATIO_4_3},
    { 4000, 2250, 33331760, SIZE_RATIO_16_9},
    { 4000, 1712, 33331760, SIZE_RATIO_21_9},
    ...
    { 2352, 1008, 33331760, SIZE_RATIO_21_9},
...
#ifndef SUPPORT_8M_LINE_BUFFER_SIZE //[HACK]
...
static int SAKGM1SP_YUV_REPROCESSING_INPUT_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
    { 4000, 3000, 33331760, SIZE_RATIO_4_3},
};
...
/* yuv reprocessing input stream size list */
static int SAKGM1SP_RAW_OUTPUT_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
    { 4000, 3000, 33331760, SIZE_RATIO_4_3},
};
...
static int SAKGM1SP_JPEG_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
#ifndef SUPPORT_8M_LINE_BUFFER_SIZE
    { 4000, 3000, 33331760, SIZE_RATIO_4_3},
...
static int SAKGM1SP_THUMBNAIL_LIST[][SIZE_OF_RESOLUTION] =
{
...
/* For HAL3 */
static int SAKGM1SP_HIGH_SPEED_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
    { 1920,  1080, 120, SIZE_RATIO_16_9},
    { 1280,   720, 240, SIZE_RATIO_16_9},
};

static int SAKGM1SP_FPS_RANGE_LIST[][2] =
{
    {   7000,  15000},
    {  15000,  15000},
    {   7000,  20000},
...
static int SAKGM1SP_HIDDEN_FPS_RANGE_LIST[][2] =
{
    {  60000,  60000},
};

/* For HAL3 */
static int SAKGM1SP_HIGH_SPEED_VIDEO_FPS_RANGE_LIST[][2] =
{
    { 30000, 120000},
    { 120000, 120000},
    { 30000, 240000},
...
static int SAKGM1SP_AVAILABLE_VIDEO_LIST[][7] =
{
#ifndef SUPPORT_8M_LINE_BUFFER_SIZE
...
static int SAKGM1SP_AVAILABLE_HIGH_SPEED_VIDEO_LIST[][5] =
{
...
/* effect fps range */
static int SAKGM1SP_EFFECT_FPS_RANGE_LIST[][2] =
{
    {  10000,  24000},
    {  24000,  24000},
};

static camera_metadata_rational COLOR_MATRIX1_GM1SP_3X3[] =
{
...
static camera_metadata_rational COLOR_MATRIX2_GM1SP_3X3[] =
{
...
static camera_metadata_rational FORWARD_MATRIX1_GM1SP_3X3[] =
{
...
static camera_metadata_rational FORWARD_MATRIX2_GM1SP_3X3[] =
{
