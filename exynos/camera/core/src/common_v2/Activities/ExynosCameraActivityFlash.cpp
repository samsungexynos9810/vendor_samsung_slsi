...
ExynosCameraActivityFlash::ExynosCameraActivityFlash(int cameraId,
...
unsigned int ExynosCameraActivityFlash::getBestFlashShotFcount()
{
    return getShotFcount() + FLASH_BEST_FRAMECOUNT_MARGIN;
}
