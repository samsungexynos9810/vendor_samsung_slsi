...
/*#define LOG_NDEBUG 0 */
#define LOG_TAG "ExynosCameraEEPRomMapOV12A10FF"

#include "ExynosCameraEEPRomMapOV12A10FF.h"

ExynosCameraEEPRomMapOV12A10FF::~ExynosCameraEEPRomMapOV12A10FF()
{
}

status_t ExynosCameraEEPRomMapOV12A10FF::m_create(const char *eepromData, const int eepromSize)
{
    ...
    ////////////////////////////////////////////////
    strncpy(m_sensorName, "OV12A10FF", EEPROM_MAP_BUF_SIZE);
...
void ExynosCameraEEPRomMapOV12A10FF::m_destroy(void)
{
}

void ExynosCameraEEPRomMapOV12A10FF::m_init(void)
{
    m_excelEEPRomSize = 5479;
    this->setName("ExynosCameraEEPRomMapOV12A10FF");
}
