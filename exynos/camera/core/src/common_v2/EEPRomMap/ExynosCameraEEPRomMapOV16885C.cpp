...
/*#define LOG_NDEBUG 0 */
#define LOG_TAG "ExynosCameraEEPRomMapOV16885C"

#include "ExynosCameraEEPRomMapOV16885C.h"

ExynosCameraEEPRomMapOV16885C::~ExynosCameraEEPRomMapOV16885C()
{
}

status_t ExynosCameraEEPRomMapOV16885C::m_create(const char *eepromData, const int eepromSize)
{
	...
	////////////////////////////////////////////////
	strncpy(m_sensorName, "OV16885C", EEPROM_MAP_BUF_SIZE);
	...
	m_copyEEPRom(m_oisHeaTarget, eepromData, 0x0030, 4, "m_oisHeaTarget");

	return ret;
}


void ExynosCameraEEPRomMapOV16885C::m_destroy(void)
{
}

void ExynosCameraEEPRomMapOV16885C::m_init(void)
{
    m_excelEEPRomSize = 5479;
    this->setName("ExynosCameraEEPRomMapOV16885C");
}
