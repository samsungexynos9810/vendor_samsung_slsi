...
/*#define LOG_NDEBUG 0 */
#define LOG_TAG "ExynosCameraEEPRomMap5E9_OTP"

#include "ExynosCameraEEPRomMap5E9_OTP.h"

ExynosCameraEEPRomMap5E9_OTP::~ExynosCameraEEPRomMap5E9_OTP()
{
}

status_t ExynosCameraEEPRomMap5E9_OTP::m_create(const char *eepromData, const int eepromSize)
{
	...
	////////////////////////////////////////////////
	strncpy(m_sensorName, "5E9_OTP", EEPROM_MAP_BUF_SIZE);
...
void ExynosCameraEEPRomMap5E9_OTP::m_destroy(void)
{

}

void ExynosCameraEEPRomMap5E9_OTP::m_init(void)
{
    m_excelEEPRomSize = 1118;
    this->setName("ExynosCameraEEPRomMap5E9_OTP");
}
