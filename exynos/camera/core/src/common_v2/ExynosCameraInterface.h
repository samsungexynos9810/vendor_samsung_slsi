...
enum CAMERA_TORCH_FLASH {
    CAMERA_TORCH_FLASH_REAR,
    CAMERA_TORCH_FLASH_FRONT,
    CAMERA_TORCH_FLASH_REAR2,
    CAMERA_TORCH_FLASH_REAR3,
};

static HAL_CameraInfo_t *g_HAL_CameraInfo[CAMERA_INDEX_ID_MAX];
static camera3_device_t *g_cam_device3[CAMERA_INDEX_ID_MAX];
...
static Mutex    g_cam_openLock[CAMERA_INDEX_ID_MAX];
static Mutex    g_cam_configLock[CAMERA_INDEX_ID_MAX];
static bool     g_cam_torchEnabled[CAMERA_ID_MAX] = {false, false};
int32_t         gNumOfCameras;
...
static int HAL_getCameraId(cameraId_Info *camIdInfo);
