...
void ArcsoftFusionBokehPreview::getFrameParams(Map_t *map)
{
    ...
    m_inParams.mainimg.i32Width = m_mapSrcRect[1][PLUGIN_ARRAY_RECT_W];
    m_inParams.mainimg.i32Height = m_mapSrcRect[1][PLUGIN_ARRAY_RECT_H];
    m_inParams.mainimg.pi32Pitch[0] = m_mapSrcBufWStride[1];
    m_inParams.mainimg.pi32Pitch[1] = m_mapSrcBufWStride[1];
    m_inParams.mainimg.pi32Pitch[2] = 0;
    m_inParams.mainimg.ppu8Plane[0] = (MUInt8*)m_mapSrcBufAddr[1][0];
    m_inParams.mainimg.ppu8Plane[1] = (MUInt8*)m_mapSrcBufAddr[1][1];
    m_inParams.mainimg.ppu8Plane[2] = 0;
    ARC_BOKEH_LOGD("main image size %dx%d pitch is %d", m_mapSrcRect[1][PLUGIN_ARRAY_RECT_W], m_mapSrcRect[1][PLUGIN_ARRAY_RECT_H],
    ...
    m_inParams.output.pi32Pitch[2] = 0;
    ...
    m_inParams.auximg.i32Width = m_mapSrcRect[0][PLUGIN_ARRAY_RECT_W];
    m_inParams.auximg.i32Height = m_mapSrcRect[0][PLUGIN_ARRAY_RECT_H];
    m_inParams.auximg.pi32Pitch[0] = m_mapSrcBufWStride[0];
    m_inParams.auximg.pi32Pitch[1] = m_mapSrcBufWStride[0];
    m_inParams.auximg.pi32Pitch[2] = 0;

    m_inParams.auximg.ppu8Plane[0] = (MUInt8*)m_mapSrcBufAddr[0][0];
    m_inParams.auximg.ppu8Plane[1] = (MUInt8*)m_mapSrcBufAddr[0][1];
    m_inParams.auximg.ppu8Plane[2] = 0;
    ARC_BOKEH_LOGD("aux image size %dx%d pitch is %d", m_mapSrcRect[0][PLUGIN_ARRAY_RECT_W], m_mapSrcRect[0][PLUGIN_ARRAY_RECT_H],
        m_mapSrcBufWStride[0]);

    m_inParams.caminfo.i32MainWidth_CropNoScale = m_teleFullsizeW;
    m_inParams.caminfo.i32MainHeight_CropNoScale = m_teleFullsizeH;

    m_inParams.caminfo.i32AuxWidth_CropNoScale = m_wideFullsizeW;
    m_inParams.caminfo.i32AuxHeight_CropNoScale = m_wideFullsizeH;
...
int32_t ArcsoftFusionBokehPreview::doArcRTBProcess()
{
    ...
    if (dump) {
        ...
        if (rfParam.bRefocusOn)
        {
            ...
            dumpYUVtoFile(&m_inParams.mainimg, "bokeh_tele", g_arc_dump_timestamp);
            dumpYUVtoFile(&m_inParams.auximg, "bokeh_wide", g_arc_dump_timestamp);
    ...
    if (dumpex) {
        ...
        {
            dumpYUVtoFile(&m_inParams.mainimg, "bokeh_tele_frame", timestamp);
            dumpYUVtoFile(&m_inParams.auximg, "bokeh_wide_frame", timestamp);
