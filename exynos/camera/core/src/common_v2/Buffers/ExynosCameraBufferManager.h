...
public:
    ...
    virtual status_t decreaseOnDemandBuffers(void) = 0;
...
public:
    ...
    status_t decreaseOnDemandBuffers(void);
...
protected:
    ...
    status_t m_decrease(int sIndex, int eIndex);
...
protected:
    ...
    status_t         m_defaultAlloc(int bIndex, int eIndex, unsigned int extraPlane);
    status_t         m_defaultFree(int bIndex, int eIndex, unsigned int extraPlane);
