...
#define OPEN_MAGIC_NUMBER		0x20192006
#define SHOT_MAGIC_NUMBER		0x45678923
...
struct camera2_aa_dm {
	...
	uint32_t			vendor_aeSettle;
	uint32_t			vendor_antiBandingEnable;
	uint32_t			vendor_reserved[47];
...
enum camera2_gyro_history_state
{
    GYRO_HISOTRY_INVALID = 0,
    GYRO_HISOTRY_SAMPLING_RATIO_100HZ,
    GYRO_HISOTRY_SAMPLING_RATIO_30HZ,
};
...
{
    enum camera2_gyro_history_state state;
...
enum camera2_scene_index {
    ...
    SCENE_INDEX_FLOWER      = 1,
    SCENE_INDEX_SUNSET_SUNRISE = 2,
    SCENE_INDEX_MARKET      = 3,
    SCENE_INDEX_STORE       = 4,
    SCENE_INDEX_STAGE       = 5,
    SCENE_INDEX_INDOOR      = 6,
    SCENE_INDEX_DOCUMENT    = 7,
    SCENE_INDEX_MOON        = 8,
};
