...
#define CAMERA_DUMP_BAYER_FORMAT        (V4L2_PIX_FMT_YUYV)
...
/*vision */
/* #define VISION_DUMP */
#define VISION_WIDTH                     (1920)
#define VISION_HEIGHT                    (1080)
#define VISION_VC_COPY_FORMAT    (V4L2_PIX_FMT_NV21M)
