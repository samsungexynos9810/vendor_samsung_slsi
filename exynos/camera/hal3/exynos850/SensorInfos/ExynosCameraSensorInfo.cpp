...
int getCameraIdInfo(cameraId_Info *camIdInfo)
{
    ...
    switch (camIdInfo->serviceCameraId) {
        ...
        case CAMERA_SERVICE_ID_DUAL_REAR_ZOOM:
            camIdInfo->cameraId[MAIN_CAM] = CAMERA_ID_BACK_2;
            camIdInfo->cameraId[SUB_CAM] = CAMERA_ID_BACK;
            camIdInfo->cameraId[SUB_CAM2] = CAMERA_ID_FRONT;
            camIdInfo->camInfoIndex = CAMERA_INDEX_DUAL_REAR_ZOOM;
            camIdInfo->numOfSensors = 3;
            camIdInfo->scenario = SCENARIO_DUAL_REAR_ZOOM;
            camIdInfo->logicalSyncType = SENSOR_SYNC_TYPE_CALIBRATED;
            camIdInfo->sensorInfoCamIdx = SUB_CAM;
            camIdInfo->dualTransitionInfo = {
                { 1.79, { DUAL_OPERATION_MODE_SLAVE,  DUAL_OPERATION_MODE_SLAVE,  { CAMERA_ID_BACK,                    }, DUAL_OPERATION_SENSOR_BACK_SUB      , DUAL_OPERATION_SENSOR_BACK_SUB      } },
                ...
                { 2.29, { DUAL_OPERATION_MODE_SYNC,   DUAL_OPERATION_MODE_MASTER, { CAMERA_ID_BACK_2, CAMERA_ID_BACK   }, DUAL_OPERATION_SENSOR_BACK_MAIN_SUB , DUAL_OPERATION_SENSOR_BACK_MAIN     } },
                { 4.79, { DUAL_OPERATION_MODE_MASTER, DUAL_OPERATION_MODE_MASTER, { CAMERA_ID_BACK_2,                  }, DUAL_OPERATION_SENSOR_BACK_MAIN     , DUAL_OPERATION_SENSOR_BACK_MAIN     } },
                { 4.99, { DUAL_OPERATION_MODE_SYNC,   DUAL_OPERATION_MODE_SYNC,   { CAMERA_ID_BACK_2, CAMERA_ID_FRONT  }, DUAL_OPERATION_SENSOR_BACK_MAIN_SUB2, DUAL_OPERATION_SENSOR_BACK_MAIN_SUB2} },
                { 5.29, { DUAL_OPERATION_MODE_SYNC,   DUAL_OPERATION_MODE_SLAVE,  { CAMERA_ID_FRONT,  CAMERA_ID_BACK_2 }, DUAL_OPERATION_SENSOR_BACK_MAIN_SUB2, DUAL_OPERATION_SENSOR_BACK_SUB2     } },
                { 10.0, { DUAL_OPERATION_MODE_SLAVE,  DUAL_OPERATION_MODE_SLAVE,  { CAMERA_ID_FRONT,                   }, DUAL_OPERATION_SENSOR_BACK_SUB2     , DUAL_OPERATION_SENSOR_BACK_SUB2     } },
            };
            break;
#endif
