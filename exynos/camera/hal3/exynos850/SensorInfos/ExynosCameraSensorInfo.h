...
struct ExynosCameraSensor12A10 : public ExynosCameraSensor12A10Base {
public:
    ExynosCameraSensor12A10(int sensorId);
};

struct ExynosCameraSensor12A10FF : public ExynosCameraSensor12A10FFBase {
public:
    ExynosCameraSensor12A10FF(int sensorId);
};

struct ExynosCameraSensor16885C : public ExynosCameraSensor16885CBase {
public:
    ExynosCameraSensor16885C(int sensorId);
};

struct ExynosCameraSensor2X5SP : public ExynosCameraSensor2X5SPBase {
public:
    ExynosCameraSensor2X5SP(int sensorId);
};
...
struct ExynosCameraSensor4EC : public ExynosCameraSensor4ECBase {
public:
    explicit ExynosCameraSensor4EC(int sensorId);
};
/* Helpper functions */
