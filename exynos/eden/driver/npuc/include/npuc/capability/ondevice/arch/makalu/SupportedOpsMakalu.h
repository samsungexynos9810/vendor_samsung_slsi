#ifndef __MAKALU_SUPPORTED_OPERATION_H__
#define __MAKALU_SUPPORTED_OPERATION_H__
...
class SupportedOperationMakalu : public SupportedOperation
{
public:
  SupportedOperationMakalu() = default;
...
#endif // __MAKALU_SUPPORTED_OPERATION_H__
