#ifndef __NEUS_SUPPORTED_OPERATION_H__
#define __NEUS_SUPPORTED_OPERATION_H__
...
class SupportedOperationNeus : public SupportedOperation
{
public:
  SupportedOperationNeus() = default;
...
#endif // __NEUS_SUPPORTED_OPERATION_H__
