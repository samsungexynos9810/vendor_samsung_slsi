#ifndef __KITT_SUPPORTED_OPERATION_H__
#define __KITT_SUPPORTED_OPERATION_H__
...
class SupportedOperationKitt : public SupportedOperation
{
public:
  SupportedOperationKitt() = default;
...
#endif // __KITT_SUPPORTED_OPERATION_H__
